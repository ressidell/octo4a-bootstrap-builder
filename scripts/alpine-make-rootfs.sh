...
alpine-devel@lists.alpinelinux.org-61666e3f.rsa.pub:
...
alpine-devel@lists.alpinelinux.org-616a9724.rsa.pub:
'
...
: ${APK_TOOLS_URI_PREAMBLE:="https://gitlab.alpinelinux.org/api/v4/projects/5/packages/generic/v2.14.0"}
...
opts=$(getopt -n $PROGNAME -o b:m:Cp:r:s:cd:t:hV \
	-l architecture:,branch:,fs-skel-chown:,fs-skel-dir:,keys-dir:,mirror-uri:,no-cleanup,no-default-pkgs,packages:,repositories-file:,script-chroot,temp-dir:,timezone:,help,version \
	-- "$@") || help 1 >&2
...
if ! command -v "$APK" >/dev/null; then
	...
	wgets "$APK_TOOLS_URI_PREAMBLE/$ALPINE_ARCH/$APK_TOOLS_URI_BIN" "$APK_TOOLS_SHA256" "$TEMP_DIR"
